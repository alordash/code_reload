...
use code_reload_core::constants::GENERATED_CODE_PREFIX;
use quote::ToTokens;
...
impl IOutputGenerator for OutputGenerator {
    fn generate(&self, build_fn_datas: Vec<BuildFnData>) -> String {
        ...
        let output = format!(r#"
// Autogenerated by code_reload crate.
#[rustfmt::skip]
pub mod __code_reload {{
    ...
    impl code_reload::IHotreloadPayload for HotreloadPayload {{
    ...
    code_reload::define_global_hotreload_variable!(HotreloadPayload);
}}
"#);
        return output;
    }
...
impl OutputGenerator {
    ...
    fn generate_field_initialization(
        ...
        let symbol_name = format!(
            "{}_{}",
            GENERATED_CODE_PREFIX, formatted_build_fn_data.ident
        );
